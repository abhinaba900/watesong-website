...
export const CompanySection: React.FC = () => {
  return (
    <section className="relative w-full flex flex-col items-center justify-center pt-[10vh] pb-[5vh] lg:pb-0">
      ...
      >
        ...
        <div className="relative w-[25vw] md:w-[20vw] lg:w-[14vw] translate-x-[2vw] md:translate-x-[4vw] lg:translate-x-[5vw] translate-y-[-2vh] md:translate-y-[-5vh] lg:translate-y-[-12vh]">
          <Image
        ...
        <div className="relative w-[45vw] md:w-[35vw] lg:w-[40vw] translate-y-[-2vh] md:translate-y-[-5vh] lg:translate-y-[-8vh] translate-x-[2vw] md:translate-x-[4vw] lg:translate-x-[5vw]">
          <Image
