...
export const CompanySection: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-screen lg:min-h-[40vh] xl:min-h-[90vh] flex flex-col justify-start pt-[15rem] lg:pt-[0vh] xl:pt-[10vh] lg:mt-[10vh] xl:mt-[10vh] pb-[15rem] lg:pb-[2vh] xl:pb-[10vh] lg:mb-[2vh] xl:mb-[40vh] gand-mardo-space-ka">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute left-[-52vw] fishing-boat-section-image-gand lg:left-[-6vw] xl:left-[-6vw] bottom-[-24vh] lg:bottom-[-12vh] xl:bottom-[-52vh] w-[28rem] md:w-[45vw] lg:w-[40vw] xl:w-[40vw] z-5 opacity-80 lg:opacity-100 xl:opacity-100"
        >
          <Image
        ...
        <motion.div className="absolute right-16 bottom-[49rem]  lg:top-[60%] xl:top-[60%] w-[80vw] md:w-[25vw] lg:w-[40dvw] xl:w-[40dvw] z-5 translate-x-[25%] lg:translate-x-[20%] xl:translate-x-[15%]  lg:opacity-100 xl:opacity-100">
          <Image
        ...
        <div className="absolute bottom-[2] lg:bottom-[-2vh] xl:bottom-[-13vh] left-[74%] lg:left-[48%] xl:left-[48%] fish-group-area-need-to-go -translate-x-1/2 flex gap-[8vw] lg:gap-[6vw] xl:gap-[6vw] opacity-80">
          <motion.div
            ...
            className="w-[50vw] lg:w-[20vw] xl:w-[17vw] mt-12"
          >
            <Image
