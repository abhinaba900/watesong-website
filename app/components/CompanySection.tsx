    ...
    <section className="relative w-full min-h-screen lg:min-h-[90vh] flex flex-col justify-start pt-[30vh] lg:pt-[10vh] lg:mt-[10vh] pb-[15vh] lg:pb-[10vh] lg:mb-[40vh] gand-mardo-space-ka">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute left-[-22vw] fishing-boat-section-image-gand lg:left-[-6vw] bottom-[-15vh] lg:bottom-[-52vh] w-[65vw] md:w-[45vw] lg:w-[42vw] z-5 opacity-80 lg:opacity-100"
        >
          <Image
